    ...
    <div>
      <div class="container">
        ...
        <div class="content">
          ...
          <p class="text">Mais do que apenas uma técnica de beleza, o alongamento de cílios se tornou um catalisador para uma mudança interna e externa, especialmente para as mulheres.</p>
          <br>
